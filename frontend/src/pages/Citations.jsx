...
Pour le dire de manière imagée, nous continuons à regarder avec des lunettes industrielles, si bien que nous ne voyons même pas la nouvelle société qui est devant nous et dans laquelle nous baignons. Parfois nous rencontrons des entreprises ou des groupes de la société civile qui sont déjà dans cette nouvelle mouvance, mais nous ne les voyons pas parce que nous n'avons pas les bonnes lunettes. »`,
  ...
  {
    text: `« Ils disent qu’une certaine femme nommée Eataentsic, est celle qui a fait la terre et les hommes. Ils luy baillent pour adioint vn certain appellé Iouskeha, qu’ils disent estre son petit-fils, auec lequel elle gouuerne le monde ; cest Iouskeha a soin des viuans & des choses qui concernent la vie, & par consequent ils disent qu’il est bon : Eataentsic a soin des ames, & parce qu’ils croyent qu’elle fait mourir les hommes, ils disent qu’elle est meschante. Et ce sont parmy eux des mysteres si cachez, qu’il n’y a que les vieillards qui en puissent parler auec credit & authorité, pour estre creus. D’où vient qu’vn certain ieune homme m’en ayant discouru, me p. 25dist en se ventant, Ne suisie pas bien sçauant ? Quelques vns me disent que la maison de ces deux Diuinitez est au bout du monde vers l’Orient. Or chez eux le monde ne passe point leur Pays, c’est à dire l’Amerique, d’autres les logent au milieu. Ce Dieu & cette Deesse viuent comme eux, mais sans disette ; font des festins comme eux, sont lascifs aussi bien qu’eux : bref ils se les figurent tous tels qu’ils sont eux mesmes. Et encor qu’il les facent hommes & corporels, ils semblent néanmoins leur attribuer vne certaine immensité en tous lieux. Ils disent que cette Eataentsic est tombée du Ciel, où il y a des habitans comme icy, & que quand elle tomba, elle estoit enceinte. Que si vous leur demandez qui a fait le Ciel & les habitans, ils n’ont autre repartie, sinon qu’ils n’en sçauent rien. Et quand nous leur preschons vn Dieu, Createur du Ciel & de la terre & de toutes choses : de mesme quand nous leur parlons d’vn Enfer & d’vn Paradis, & du reste de nos mysteres ; les opiniastres respondent, que cela est bon pour nostre Pays, non pour le leur ; que chaque Pays a ses façons de faire. »`,
    ...
    <div className="page">
      <div className="container" style={{ display: "grid", gap: "32px" }}>
        <header className="grid" style={{ gap: "16px" }}>
          ...
          <p className="lead">
            Cette collection rassemble des paroles fondatrices qui nourrissent EGOEJO. Elles sont
            présentées dans leur intégralité pour respecter la puissance de leurs messages.
          </p>
        </header>

        <div className="grid" style={{ gap: "20px" }}>
          {QUOTES.map(({ text, author }, index) => (
            <article key={`${author}-${index}`} className="glass" style={{ padding: "24px" }}>
              <blockquote style={{ margin: 0, display: "grid", gap: "12px" }}>
                <p className="muted" style={{ lineHeight: 1.65, whiteSpace: "pre-wrap" }}>
                  {text}
                </p>
    ...
    <div className="page">
      <div className="container" style={{ display: "grid", gap: "32px" }}>
        <header className="grid" style={{ gap: "16px" }}>
          ...
          <h1 className="heading-l">Voix qui nous accompagnent</h1>
          <p className="lead">
            Cette collection rassemble des paroles fondatrices qui nourrissent EGOEJO. Elles sont présentées dans leur
            intégralité pour respecter la puissance de leurs messages.
          </p>
        </header>
        ...
        <div className="grid" style={{ gap: "20px" }}>
          {QUOTES.map(({ text, author }, index) => (
            <article key={`${author}-${index}`} className="glass" style={{ padding: "24px" }}>
              <blockquote style={{ margin: 0, display: "grid", gap: "12px" }}>
                <p className="muted" style={{ lineHeight: 1.65, whiteSpace: "pre-wrap" }}>{text}</p>
                <cite style={{ fontStyle: "normal", color: "var(--accent)" }}>{author}</cite>
              </blockquote>
            </article>
          ))}

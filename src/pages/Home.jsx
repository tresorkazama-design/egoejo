  ...
  return (
    <>
      ...
      <section id="soutenir" style={{ padding: "40px 16px", maxWidth: 1200, margin: "0 auto" }}>
        ...
        <p>Deux options rapides : AdhÃƒÂ©sion/Don via Stripe, ou HelloAsso si vous ÃƒÂªtes en France (asso).</p>
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          <a href="/api/checkout-create" style={btn}>AdhÃƒÂ©rer / Donner (Stripe)</a>
